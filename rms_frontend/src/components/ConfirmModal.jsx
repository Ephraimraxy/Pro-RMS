...
const ConfirmModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      />
      <div className="glass bg-white/95 w-full max-w-sm rounded-[2rem] border border-border/50 shadow-2xl relative overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
